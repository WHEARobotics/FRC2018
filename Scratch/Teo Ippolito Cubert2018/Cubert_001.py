    ...
    def teleopPeriodic(self):
       ...
       # self.auto_loop_counter +=1
        ...
        if self.counter % 90 == 0:
            # Uncomment whichever line you want to use.  Need to have a shooter to use the second one.
            print(self.counter, ' pos: ', self.l_motor1.getQuadraturePosition() , self.r_motor1.getQuadraturePosition())
            

            """
            print(self.counter)
            """
            print(self.counter, ' axis: ', self.l_joy.getRawAxis(2) and self.r_joy.getRawAxis(2), ' pos: ', self.loader.getQuadraturePosition(), ' rpm: ', self.loader.getQuadratureVelocity())
